...
export default function Logo() {
  ...
  return (
    <div className="h-[150px] w-[250px] flex items-center justify-center">
        {logoUrl ? (
            <Image src={logoUrl} alt="Bedrijfslogo" width={250} height={150} className="object-contain" unoptimized />
        ) : (
